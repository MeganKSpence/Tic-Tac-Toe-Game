  ...
  if (easyTrigger == true) {
    for (int j = 0; j < alreadyUsed.length; j++) {
      if (boardPiece[0] == "X" && easyModeTrigger[0] == false) { 
        ...
        count++;
        println(easyModeArray[0], "Position 1 clicked");
        ...
        println(easyModeArray[0], "Gonna retry for position 1");
      }
      if (boardPiece[1] == "X" && easyModeTrigger[1] == false) {
        ...
        count++;
        println(easyModeArray[1], "position 2 clicked");
        ...
        println(easyModeArray[1], "gonna retry for position 2");
      }
      if (boardPiece[2] == "X" && easyModeTrigger[2] == false) {
        ...
        count++;
        println(easyModeArray[2], "position 3 clicked");
        ...
        println(easyModeArray[2], "gonna retry for position 3");
      }
       if (boardPiece[3] == "X" && easyModeTrigger[3] == false) {
        ...
        count++;
        println(easyModeArray[3], "position 4 clicked");
        ...
        println(easyModeArray[3], "gonna retry for position 4");
      }
       if (boardPiece[4] == "X" && easyModeTrigger[4] == false) {
        ...
        count++;
        println(easyModeArray[4], "position 5 clicked");
        ...
        println(easyModeArray[4], "gonna retry for position 5");
      }
     if (boardPiece[5] == "X" && easyModeTrigger[5] == false) {
        ...
        count++;
        println(easyModeArray[5], "position 6 clicked");
        ...
        println(easyModeArray[5], "gonna retry for position 6");
      }
      if (boardPiece[6] == "X" && easyModeTrigger[6] == false) {
        ...
        count++;
        println(easyModeArray[6], "position 7 clicked");
        ...
        println(easyModeArray[6], "gonna retry for position 7");
      }
       if (boardPiece[7] == "X" && easyModeTrigger[7] == false) {
        ...
        count++;
        println(easyModeArray[7], "position 8 clicked");
        ...
        println(easyModeArray[7], "gonna retry for position 8");
      }
       if (boardPiece[8] == "X" && easyModeTrigger[8] == false) {
        ...
        count++;
        println(easyModeArray[8], "position 9 clicked");
        ...
        println(easyModeArray[8], "gonna retry for position 9");
      }
    }
  }
}
