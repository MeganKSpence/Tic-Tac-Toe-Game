...
void xoText (String text, int position) {
  ...
  if (position == 1 && trigger2 == true && positionTrigger == false) {
    Text_Setup(text, xoFont, height, 0, CENTER, CENTER, width*2/5, height*0, width*1/5, height*1/3);
    boardPiece[0] = text;
  ...
  if (position == 2 && trigger2 == true && positionTrigger2 == false) {
    Text_Setup(text, xoFont, height, 0, CENTER, CENTER, width*3/5, height*0, width*1/5, height*1/3);
    boardPiece[1] = text;
  ...
  if (position == 3 && trigger2 == true && positionTrigger3 == false) {
    Text_Setup(text, xoFont, height, 0, CENTER, CENTER, width*4/5, height*0, width*1/5, height*1/3);
    boardPiece[2] = text;
  ...
  if (position == 4 && trigger2 == true && positionTrigger4 == false) {
    Text_Setup(text, xoFont, height, 0, CENTER, CENTER, width*2/5, height*1/3, width*1/5, height*1/3);
    boardPiece[3] = text;
  ...
  if (position == 5 && trigger2 == true && positionTrigger5 == false) {
    Text_Setup(text, xoFont, height, 0, CENTER, CENTER, width*3/5, height*1/3, width*1/5, height*1/3);
    boardPiece[4] = text;
  ...
  if (position == 6 && trigger2 == true && positionTrigger6 == false) {
    Text_Setup(text, xoFont, height, 0, CENTER, CENTER, width*4/5, height*1/3, width*1/5, height*1/3);
    boardPiece[5] = text;
  ...
  if (position == 7 && trigger2 == true && positionTrigger7 == false) {
    Text_Setup(text, xoFont, height, 0, CENTER, CENTER, width*2/5, height*2/3, width*1/5, height*1/3);
    boardPiece[6] = text;
  ...
  if (position == 8 && trigger2 == true && positionTrigger8 == false) {
    Text_Setup(text, xoFont, height, 0, CENTER, CENTER, width*3/5, height*2/3, width*1/5, height*1/3);
    boardPiece[7] = text;
  ...
  if (position == 9 && trigger2 == true && positionTrigger9 == false) {
    Text_Setup(text, xoFont, height, 0, CENTER, CENTER, width*4/5, height*2/3, width*1/5, height*1/3);
    boardPiece[8] = text;
